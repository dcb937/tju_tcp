...
void print_packet_header(char* packet)
{
    ...
    printf("src: %d ", get_src(packet));
    printf("dst: %d ", get_dst(packet));
    printf("seq: %d ", get_seq(packet));
    printf("ack: %d ", get_ack(packet));
    printf("len: %d ", get_hlen(packet));
    printf("plen: %d ", get_plen(packet));
    printf("flags: %d ", get_flags(packet));
    printf("advertised_window: %d ", get_advertised_window(packet));
    printf("ext: %d\n\n", get_ext(packet));
}
